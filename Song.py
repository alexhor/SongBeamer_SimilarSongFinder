...
class Song:
    supported_verse_heading_list = ["Unbekannt", "Unbenannt", "Unknown", "Intro", "Vers", "Verse", \
                                    "Strophe", "Pre-Bridge", "Bridge", "Misc", "Pre-Refrain", "Refrain", \
                                    "Pre-Chorus", "Chorus", "Pre-Coda", "Zwischenspiel", "Instrumental", \
                                    "Interlude", "Coda", "Ending", "Outro", "Teil", "Part", "Chor", "Solo"]
        ...
        for line in content:
            ...
            if(verse_ended_in_last_line):
                ...
                if(line[0:3] == "$$M="):
                    ...
                    if((verse_heading in self.supported_verse_heading_list and (heading_number == "" or re.search("^[0-9][a-z]?$", heading_number))) \
                       or \
                       ((verse_heading == "Part" or verse_heading == "Teil") and re.search("^[A-Z]$", heading_number))):
                        line_is_songtext = False
